...
from trading_service.database import create_tables
from trading_service.routers import assets, transactions
from trading_service.exceptions.handlers import register_exception_handlers
